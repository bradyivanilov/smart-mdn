    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <?php foreach ($teachers as $t): ?>
            <div class="bg-white rounded-3xl p-5 border border-slate-200 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md transition">
                <div>
                    <div class="flex items-start justify-between gap-2">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <h3 class="font-bold text-sm text-slate-800 leading-snug"><?= esc($t['full_name']) ?></h3>
                ...
                <!-- Action Buttons: Portofolio e-CV & Supervisi KBM -->
                <div class="pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
                    <a href="<?= base_url('portfolio/' . $t['nip']) ?>" target="_blank"
                       class="flex-1 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-semibold flex items-center justify-center gap-1.5 transition">
                        <i data-lucide="external-link" class="w-3.5 h-3.5"></i>
                        <span>Portofolio (e-CV)</span>
                    </a>
